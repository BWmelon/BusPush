...
Page({
  ...
  data: {
    list: [
      {
        q: '授权位置信息时不小心点了禁止怎么办',
        a: '由于HarmonyOS系统的限制，在用户禁止某项授权后，软件无法再次发起授权弹窗，请在智能手表中的设置-应用-权限管理-权限-位置信息-腕上公交中将位置信息权限选择为始终允许即可。',
        important: true
      },
      {
        q: '自动查询有什么用',
      ...
      {
        q: '如何查看可视化公交路线信息',
        a: '在实时公交查询页面时点击屏幕即可查看可视化公交路线信息。',
        important: false
      },
      {
        q: '公交到站后如何快速退出软件',
        a: '在实时公交查询页面时长按屏幕会弹窗是否确认退出弹窗，点击确认按钮即可退出应用。',
        important: false
      },
      {
